...
namespace AOC_01
{
    ...
    class SolverThree
    {
        public int Solve(int target, List<int> expenses)
        {
            foreach (int i in expenses)
            {
                foreach (int j in expenses)
                {
                    if (i == j)
                    {
                        continue;
                    }
                    foreach (int k in expenses)
                    {
                        if (i == k)
                        {
                            continue;
